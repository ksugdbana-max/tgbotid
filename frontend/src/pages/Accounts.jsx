...
// Complete world phone prefix → country name mapping (sorted longest-first for accuracy)
const PHONE_COUNTRY_MAP = {
    '+93': 'Afghanistan', '+355': 'Albania', '+213': 'Algeria', '+376': 'Andorra',
    '+244': 'Angola', '+1268': 'Antigua and Barbuda', '+54': 'Argentina',
    ...
    '+226': 'Burkina Faso', '+257': 'Burundi', '+238': 'Cabo Verde',
    '+855': 'Cambodia', '+237': 'Cameroon', '+1': 'United States',
    '+236': 'Central African Republic', '+235': 'Chad', '+56': 'Chile',
    '+86': 'China', '+57': 'Colombia', '+269': 'Comoros', '+242': 'Congo',
    '+243': 'Congo (DRC)', '+506': 'Costa Rica', '+225': "Côte d'Ivoire",
    ...
    '+1473': 'Grenada', '+502': 'Guatemala', '+224': 'Guinea',
    ...
    '+962': 'Jordan', '+7': 'Russia', '+254': 'Kenya', '+686': 'Kiribati',
    ...
    '+382': 'Montenegro', '+212': 'Morocco', '+258': 'Mozambique',
    '+95': 'Myanmar (Burma)', '+264': 'Namibia', '+674': 'Nauru', '+977': 'Nepal',
    ...
    '+680': 'Palau', '+507': 'Panama', '+675': 'Papua New Guinea',
    '+595': 'Paraguay', '+51': 'Peru', '+63': 'Philippines', '+48': 'Poland',
    '+351': 'Portugal', '+974': 'Qatar', '+40': 'Romania',
    '+250': 'Rwanda', '+1869': 'Saint Kitts and Nevis', '+1758': 'Saint Lucia',
    ...
    '+998': 'Uzbekistan', '+678': 'Vanuatu', '+379': 'Vatican City',
...
const Accounts = () => {
    ...
    const detectCountryFromPhone = (phone) => {
        // Sort prefixes longest-first to avoid +1 matching before +1868 etc.
        const sortedPrefixes = Object.keys(PHONE_COUNTRY_MAP).sort((a, b) => b.length - a.length);
        for (const prefix of sortedPrefixes) {
            if (phone.startsWith(prefix)) {
                const countryName = PHONE_COUNTRY_MAP[prefix];
